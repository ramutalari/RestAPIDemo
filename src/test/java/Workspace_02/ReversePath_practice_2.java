...
public class ReversePath_practice_2 {
    ...
    static String reversePath(String path){
        ...
        for (int i= pathChar.length-1;i>=0;i--)
        {
            ...
            if (String.valueOf(pathChar[i]).equals("\\") || String.valueOf(pathChar[i]).equals("/") ||

            String.valueOf(pathChar[i]).equals(":") || i == 0)
            {
    ...
    public static void main(String[] args) {
        ...
        for (String path : paths)
        {
            ...
            System.out.println("Reverse path:"+reversed);
        }
    }
}
